...
; Folkora story events
	...
	const EVENT_GOT_GLUTTLE_FROM_PAWPAW
	const EVENT_GOT_CUPICO_FROM_PAWPAW
	const EVENT_GOT_DOSSIER_FROM_POPLAR
	const EVENT_GOT_POKEDEX_FROM_POPLAR
	const EVENT_GAVE_DOSSIER_TO_PAWPAW
	const EVENT_FOUGHT_FIELD_LAB_MAGIGOON
	const EVENT_BEAT_RUSTY_CHECK
	const EVENT_BOAT_PERMISSION
	const EVENT_MET_GIL
	const EVENT_PROF_MEETING
	const EVENT_JOLLY_SODS_POPLAR
	const EVENT_DEFEATED_LUMBERJACKS
	const EVENT_POPLAR_IN_CLASSROOM
	const EVENT_OLSTEETON_ASHER
	const EVENT_ROUTE_103_RIVAL_BATTLE
	const EVENT_ROUTE_103_AUGUROTH_ENCOUNTER
	...
	const EVENT_REFUSED_TO_TAKE_EGG_FROM_PAWPAWS_AIDE
	const EVENT_GOT_TOGEPI_EGG_FROM_PAWPAWS_AIDE
	...
	const EVENT_GOT_ODD_SOUVENIR_FROM_PAWPAW
	...
	const EVENT_GOT_MASTER_BALL_FROM_PAWPAW
...
;Folkora events
	...
	const EVENT_APTROOF_FOUND_PSYDUCK
...
;Folkora People
	const EVENT_BRINESBURG_GYM_SAL
...
; Folkora itemballs
	...
	const EVENT_ROUTE_103_WHITE_HERB
	const EVENT_PLAYER_HOUSE_POTION
	const EVENT_OLSTEETON_ETHER
	const EVENT_OLSTEETON_ABANDONED_MILL_METAL_COAT
	const EVENT_OLSTEETON_ABANDONED_MILL_STARDUST
	const EVENT_OLSTEETON_ABANDONED_MILL_BURN_HEAL
	const EVENT_OLSTEETON_ABANDONED_MILL_ULTRA_BALL
	const EVENT_NATIONAL_FOREST1_ANTIDOTE


; Folkora hidden items
	...
	const EVENT_BRINESBURG_HIDDEN_FULL_HEAL
...
; Johto hidden items
	...
	; const EVENT_GOLDENROD_UNDERGROUND_HIDDEN_SUPER_POTION ; Nat Forest 1
	...
	; const EVENT_ROUTE_28_HIDDEN_RARE_CANDY ;players house
	const EVENT_ROUTE_30_HIDDEN_POTION ; hollowport
	...
	; const EVENT_ROUTE_34_HIDDEN_SUPER_POTION ;route 101
	; const EVENT_ROUTE_35_HIDDEN_NUGGET ;hollowport
...
; Crystal-exclusive events in Johto
	...
	; const EVENT_GOT_NET_BALL_FROM_GOLDENROD ;olsteeton quick ball
...
; Kanto hidden items
	...
	; const EVENT_VERMILION_CITY_HIDDEN_FULL_HEAL ;Brinesburg
...
; Blackbelt T
	...
	const EVENT_BEAT_BLACKBELT_BENJI
...
; Engineer
	...
	const EVENT_BEAT_ENGINEER_BRADFORD
; Teacher
...
; Lumberjack
	const EVENT_BEAT_LUMBERJACK_BRETT
	const EVENT_BEAT_LUMBERJACK_VINCE
	const EVENT_BEAT_LUMBERJACK_OSWALD
	const EVENT_BEAT_LUMBERJACK_JORDAN
; Artist
...
;Waitress
	const EVENT_BEAT_WAITRESS_TWILA
	const EVENT_BEAT_WAITRESS_BEV
...
; Johto itemballs
	...
	; const EVENT_UNION_CAVE_1F_AWAKENING ; Nat Forest 1
	...
	; const EVENT_GOLDENROD_DEPT_STORE_B1F_ETHER ; olsteeton ether
	; const EVENT_GOLDENROD_DEPT_STORE_B1F_METAL_COAT ; olsteeton abandoned mill
	...
	; const EVENT_ROUTE_29_POTION ; players house
	; const EVENT_ROUTE_31_POTION ;route 101
	; const EVENT_ROUTE_31_POKE_BALL ;route 101
	; const EVENT_ROUTE_32_GREAT_BALL ;route 102
	; const EVENT_ROUTE_32_REPEL ; route 102
	const EVENT_ROUTE_32_COAST_SOFT_SAND
	; const EVENT_ROUTE_32_COAST_WHITE_HERB ;route 103
	...
	; const EVENT_GOLDENROD_HARBOR_STAR_PIECE ;field lab
...
; Johto people
	const EVENT_ELDER_HOLLOWPORT
	const EVENT_BROOKE_HOLLOWPORT
	const EVENT_BROOKE_ROUTE101
	...
	const EVENT_PAWPAWS_AIDE_IN_LAB
	const EVENT_BROOKE_IN_PAWPAWS_LAB
...
; New to Crystal
	...
	; const EVENT_PICKED_UP_STARDUST_FROM_OMANYTE_ITEM_ROOM abandoned mill
	...
	const EVENT_SAW_AUGUROTH_AT_CIANWOOD_CITY
	const EVENT_SAW_AUGUROTH_ON_ROUTE_42
	const EVENT_SAW_AUGUROTH_ON_ROUTE_36
	const EVENT_ECRUTEAK_HOUSE_WANDERING_SAGE
	const EVENT_TIN_TOWER_1F_AUGUROTH
...
; Cut trees
	...
	const EVENT_ROUTE_103_CUT_TREE_1
	const EVENT_ROUTE_103_CUT_TREE_2
