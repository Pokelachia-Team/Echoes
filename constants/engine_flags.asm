...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_BRINESBURG
...
; wPokemonJournals
	...
	const ENGINE_READ_PROF_FIR_JOURNAL
...
; wPlayerCaught
	...
	const ENGINE_PLAYER_CAUGHT_AUGUROTH
