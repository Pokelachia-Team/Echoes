...
endr
	...
	givepoke NIBLAX, PLAIN_FORM, 7, ORAN_BERRY
	givepoke CHOMPSAW, PLAIN_FORM, 40, ORAN_BERRY
	; variant form test
...
;	setevent EVENT_GOT_A_POKEMON_FROM_PAWPAW
	...
	setevent EVENT_BEAT_WAITRESS_TWILA
	setevent EVENT_BEAT_WAITRESS_BEV
	setevent EVENT_BEAT_BAKER_SYLVIA
	setmapscene OLSTEETON_ROUTE_103_GATE, SCENE_OLSTEETON_ROUTE_103_GATE_NOOP
	; setmapscene NATIONAL_FOREST_1, SCENE_NATIONAL_FOREST_1_NOOP
	...
	; warpfacing DOWN, BRINESBURG, 34, 20
	end
