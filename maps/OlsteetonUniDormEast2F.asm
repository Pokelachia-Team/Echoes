OlsteetonUniDormEast2F_MapScriptHeader:
	...
	object_event 14,  3, SPRITE_BATTLE_GIRL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, PAL_NPC_GREEN, OBJECTTYPE_COMMAND, jumptextfaceplayer, OlsteetonUniDormEast2FCooltrainerfText, -1
