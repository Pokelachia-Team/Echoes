OlsteetonUniOfficePoplar_MapScriptHeader:
	...
	object_event  4,  4, SPRITE_FIR, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_POPLAR_OFFICE_FIR
	object_event  5,  4, SPRITE_ASHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_POPLAR_OFFICE_FIR
