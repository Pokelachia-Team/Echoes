...
INCLUDE "maps/OlsteetonUniClassroomBio.asm"
...
INCLUDE "maps/BrinesburgDebriteTradeHouse.asm"
INCLUDE "maps/BrinesburgFeudLeftHouse.asm"
INCLUDE "maps/BrinesburgFeudRightHouse.asm"
