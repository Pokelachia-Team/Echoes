...
if DEF(FAITHFUL)
	...
	tr_mon 72, GARGANACL @ WEAK_POLICY, FEMALE
...
endc
	...
	tr_mon 74, WHIMSICOTT @ LUM_BERRY, FEMALE
		tr_extra PRANKSTER, SATK_UP_ATK_DOWN
		tr_evs 252 HP, 4 Def, 252 SAt
...
WillGroup:
	...
	tr_mon 68, WHIMSICOTT @ ROOM_SERVICE, MALE
		tr_extra PRANKSTER, SATK_UP_SPE_DOWN
		tr_evs 252 HP, 4 Def, 252 SAt
...
BrockGroup:
	...
	tr_mon 73, GARGANACL @ ASSAULT_VEST, MALE
		tr_extra SOLID_ROCK, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 SDf, 252 Atk
	...
	tr_mon 75, GIGALITH @ LEFTOVERS, MALE
		tr_extra STURDY, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 SDf, 252 Atk
...
endc
	...
	tr_mon 66, WHIMSICOTT @ ROOM_SERVICE, MALE
		tr_extra PRANKSTER
		tr_evs 252 HP, 4 Def, 252 SAt
		tr_moves PSYCHIC_M, SLUDGE_BOMB, TRICK_ROOM, GIGA_DRAIN
	tr_mon 68, GARGANACL @ ASSAULT_VEST, MALE
		tr_extra SOLID_ROCK, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 SDf, 252 Atk
	...
	tr_mon 70, RIVASTION @ MYSTIC_WATER, MALE
		tr_extra TORRENT
		tr_evs 252 HP, 4 Atk, 252 SAt
if DEF(FAITHFUL)
...
endc
	...
	tr_mon 75, RIVASTION @ WHITE_HERB, MALE
		tr_extra HUGE_POWER, SPE_UP_ATK_DOWN
		tr_evs 252 SAt, 4 SDf, 252 Spe
...
RedGroup:
	...
	tr_mon 85, CONKELDURR @ ASSAULT_VEST, MALE
		tr_extra GUTS, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 SDf, 252 Atk
...
ProfFirGroup:
	...
	tr_mon 63, GARGANACL @ CUSTAP_BERRY, FEMALE
...
TowerTycoonGroup:
	...
	tr_mon 74, GARGANACL @ CUSTAP_BERRY, MALE
		tr_extra SOLID_ROCK, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 SDf, 252 Atk
...
if DEF(FAITHFUL)
	...
	tr_mon 76, GARGANACL @ LEFTOVERS, MALE
		tr_extra SOLID_ROCK, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 Def, 252 Atk
		tr_moves EARTHQUAKE, STONE_EDGE, MEGAHORN, IRON_HEAD
endc
...
RileyGroup:
	...
	tr_mon 56, GARGANACL @ LOADED_DICE, MALE
...
endc
	...
	tr_mon 64, GIGALITH @ ASSAULT_VEST, MALE
		tr_extra STURDY, DEF_UP_SPE_DOWN
...
endc
	...
	def_trainer 2, "Buck"
	tr_mon 75, GIGALITH @ CHOICE_BAND, MALE
		tr_extra STURDY, DEF_UP_SATK_DOWN
...
AnabelGroup:
	...
	tr_mon 73, RIVASTION @ WHITE_HERB, FEMALE
		tr_extra HUGE_POWER, SATK_UP_ATK_DOWN
...
MarlonGroup:
	...
	tr_mon 73, RIVASTION @ ASSAULT_VEST, MALE
		tr_extra HUGE_POWER, SATK_UP_ATK_DOWN
		tr_evs 252 HP, 4 SDf, 252 SAt
...
YellowGroup:
	...
	tr_mon 73, "Gravvy", GIGALITH @ CUSTAP_BERRY, FEMALE
		tr_extra STURDY, ATK_UP_SATK_DOWN
		tr_evs 252 HP, 4 SDf, 252 Atk
...
WalkerGroup:
	...
	tr_mon 73, PYROBOROS @ LEFTOVERS, MALE
		tr_extra BLAZE, SPE_UP_SATK_DOWN
		tr_evs 252 Atk, 4 def, 252 Spe
if DEF(FAITHFUL)
