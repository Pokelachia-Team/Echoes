...
; entries correspond to trainer classes (see constants/trainer_constants.asm)
	...
	db MUSIC_YOUNGSTER_ENCOUNTER ; sal
	...
	db MUSIC_LYRA_ENCOUNTER_HGSS ; brooke1
	db MUSIC_LYRA_ENCOUNTER_HGSS ; brooke2
	db MUSIC_RIVAL_ENCOUNTER ; asher1
	; db MUSIC_RIVAL_ENCOUNTER ; asher2
