InitialEvents:
	dw EVENT_OLSTEETON_ASHER
	dw EVENT_BRINESBURG_GYM_SAL
	dw ROUTE_103_RIVAL_BATTLE
	dw EVENT_ROUTE_103_AUGUROTH_ENCOUNTER
	...
	dw EVENT_ELDER_HOLLOWPORT
	dw EVENT_LYRA_IN_HER_ROOM
	dw EVENT_BROOKE_HOLLOWPORT
	dw EVENT_BROOKE_ROUTE101
	...
	dw EVENT_SAW_AUGUROTH_ON_ROUTE_36
	dw EVENT_SAW_AUGUROTH_ON_ROUTE_42
	dw EVENT_SAW_AUGUROTH_AT_CIANWOOD_CITY
