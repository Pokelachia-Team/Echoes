...
BattleMusic_Trainers:
	...
	db BROOKE1,          MUSIC_RIVAL_BATTLE_XY
	db BROOKE2,          MUSIC_WALLY_BATTLE_ORAS
	db ASHER1,           MUSIC_RIVAL_BATTLE
	; db ASHER2,           MUSIC_RIVAL_BATTLE
...
BattleMusic_Legendaries:
	...
	music_legendary AUGUROTH,  PLAIN_FORM,    MUSIC_SUICUNE_BATTLE
