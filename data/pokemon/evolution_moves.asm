...
endc
	...
	db NO_MOVE      ; MEOWTH, FOLKORAN_FORM

	db NO_MOVE      ; URSALUNA, URSALUNA_BLOODMOON_FORM

	db NO_MOVE		; GARGANACL, GARGANACL_HERBAL_FORM
	db NO_MOVE 		; GARGANACL, GARGANACL_SMOKED_FORM
	db NO_MOVE 		; GARGANACL, GARGANACL_XTRA_FORM
