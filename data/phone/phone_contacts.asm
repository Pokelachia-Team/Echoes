...
; entries correspond to PHONE_* constants
	...
	phone TRAINER_NONE, PHONECONTACT_PAWPAW,      HOLLOWPORT,                  %1111, ElmPhoneScript1,     %0000, ElmPhoneScript2
	phone TRAINER_NONE, PHONECONTACT_BROOKE,     HOLLOWPORT,            %1111, LyraPhoneScript,     %0000, LyraPhoneScript2
	phone TRAINER_NONE, PHONECONTACT_TOLLFREE,     N_A,                       %1111, TollFreePhoneScript1,    %0000, TollFreePhoneScript2
