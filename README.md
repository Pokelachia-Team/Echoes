# Pokémon Echoes
This is a custom Pokémon game based on 
...
We are setting out to create a game set in an enitrely new region, based on the real world region of Appalachia. We are nearing completion on the early Alpha phase of the game.
