...
* Several Pokémon that were removed in older patches due to engine limitations were later re-included (for example: Spearow, Fearow, Lickitung, Goldeen, Seaking, Hoppip, Skiploom, Jumpluff, Shuckle, Aipom, Stantler, Cleffa, Igglybuff, Smoochum, and Durant) — see CHANGELOG.md and bsp/save_patches.txt for historical notes and index changes.
