AnimationExtraPointers:
	...
	dw NiblaxAnimationExtra
	dw ChompsawAnimationExtra
	...
	dw NacliAnimationExtra
	dw NaclstackAnimationExtra
	...
	dw MeowthFolkoranAnimationExtra

	dw UrsalunaBloodmoonAnimationExtra

	dw GarganaclHerbalAnimationExtra
	dw GarganaclSmokedAnimationExtra
	dw GarganaclXtraAnimationExtra
